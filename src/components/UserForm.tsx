  ...
  return (
    <PopupUI setOpen={setOpen}>
      <h5 className="font-bold">
        {mode === "register" ? "Wait! You have to register!!!" : "Editing info"}
      </h5>
      <h6>
          ...
          <Form autoComplete="off">
            ...
            <Collapse open={prefectDetails}>
              <div className="text-lg">
                Go get your transcript via teachhub, and look for something that
                says "Offical Class", input the 3 digit code, that looks like
                this "A1B"
              </div>
            </Collapse>
            ...
            />
            <br />
            If you were introduced to this club by someone, please ask for their
            email and put it here.
